...
class User(db.Model):
    ...
    r_group_comment = db.relationship("GroupComment", backref="author", lazy=True, uselist=False)
    r_group_application = db.relationship("GroupApplication", backref="applicant", lazy=True, uselist=False)
